...
void Scene_Battle::CreateUi() {
	...
	help_window.reset(new Window_Help(this, Player::battle_offset_x, Player::battle_offset_y, MENU_WIDTH, 32));
	help_window->SetVisible(false);

	item_window.reset(new Window_Item(this, Player::battle_offset_x, (Player::battle_offset_y + MENU_HEIGHT - 80), MENU_WIDTH, 80));
	...
	skill_window.reset(new Window_BattleSkill(this, Player::battle_offset_x, (Player::battle_offset_y + MENU_HEIGHT - 80), MENU_WIDTH, 80));
	skill_window->SetHelpWindow(help_window.get());

	message_window.reset(new Window_Message(this, Player::battle_offset_x, (Player::battle_offset_y + MENU_HEIGHT - 80), MENU_WIDTH, 80));
